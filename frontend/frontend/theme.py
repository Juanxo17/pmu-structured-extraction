...
# Azul pastel — único color para todos los gráficos de barras de Resumen
# (pedido explícito de diseño: mismo color en todos, sin distinguir
# categoría por hue). Revalidado con el validador de paletas colorblind-safe
# del skill de dataviz; el WARN de contraste vs. fondo es aceptable porque
# cada barra siempre lleva su valor como texto plano al lado.
